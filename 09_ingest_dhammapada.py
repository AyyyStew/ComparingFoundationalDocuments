# %% [markdown]
# # Ingest & Embed — Dhammapada
# Parses data/buhhdist/dhammapada.txt (Project Gutenberg, Müller translation),
...
from db.ingest import ingest_dhammapada

TXT_PATH   = "data/buhhdist/dhammapada.txt"
...
# %% Ingest passages
conn = get_conn()
corpus_id, passage_ids = ingest_dhammapada(TXT_PATH, corpus_db_conn=conn)
